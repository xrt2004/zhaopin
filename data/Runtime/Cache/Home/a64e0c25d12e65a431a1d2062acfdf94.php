...
<head>
<?php $tag_news_category_class = new \Common\qscmstag\news_categoryTag(array('列表名'=>'info','资讯小类'=>$_GET['id'],'cache'=>'0','type'=>'run',));$info = $tag_news_category_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"资讯中心 -  {categoryname} -{site_name}","keywords"=>"","description"=>"","header_title"=>""),$info);?>
	...
	<div class="tnav">
		...
		<div class="tl">
			<ul class="link_gray6 nowrap">
				<?php $tag_nav_class = new \Common\qscmstag\navTag(array('列表名'=>'nav','调用名称'=>'QS_top','显示数目'=>'10','cache'=>'0','type'=>'run',));$nav = $tag_nav_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"资讯中心 -  {categoryname} -{site_name}","keywords"=>"","description"=>"","header_title"=>""),$nav);?>
...
<?php $tag_news_category_class = new \Common\qscmstag\news_categoryTag(array('列表名'=>'category','显示数目'=>'8','资讯大类'=>'1','cache'=>'0','type'=>'run',));$category = $tag_news_category_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"资讯中心 -  {categoryname} -{site_name}","keywords"=>"","description"=>"","header_title"=>""),$category);?>
<div class="newslip">
  <div class="l">
        <div class="newsnav">
	...
	<?php $tag_news_list_class = new \Common\qscmstag\news_listTag(array('列表名'=>'list','关键字'=>$_GET['key'],'分页显示'=>'1','资讯小类'=>$_GET['id'],'填补字符'=>'…','摘要长度'=>'160','cache'=>'0','type'=>'run',));$list = $tag_news_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"资讯中心 -  {categoryname} -{site_name}","keywords"=>"","description"=>"","header_title"=>""),$list);?>
    <div class="newslist">
  ...
  <div class="r">
    ...
    <div class="cat">
		<ul class="link_gray6">
	  	<!--<li class="odd <?php if($_GET['id']== 0 || $_GET['id']== ''): ?><a href="<?php echo url_rewrite('QS_newslist');?>">全部</a></li>-->
	...
	<?php $tag_news_list_class = new \Common\qscmstag\news_listTag(array('列表名'=>'hot_list','显示数目'=>'5','属性'=>'3','cache'=>'0','type'=>'run',));$hot_list = $tag_news_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"资讯中心 -  {categoryname} -{site_name}","keywords"=>"","description"=>"","header_title"=>""),$hot_list);?>
    ...
    <?php $tag_ad_class = new \Common\qscmstag\adTag(array('列表名'=>'ad','广告位名称'=>'QS_news_right','广告数量'=>'2','cache'=>'0','type'=>'run',));$ad = $tag_ad_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"资讯中心 -  {categoryname} -{site_name}","keywords"=>"","description"=>"","header_title"=>""),$ad);?>
    ...
    <?php $tag_news_list_class = new \Common\qscmstag\news_listTag(array('列表名'=>'recommend_list','显示数目'=>'5','属性'=>'4','cache'=>'0','type'=>'run',));$recommend_list = $tag_news_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"资讯中心 -  {categoryname} -{site_name}","keywords"=>"","description"=>"","header_title"=>""),$recommend_list);?>
...
<div class="footer_min" id="footer">
	...
	<?php $tag_explain_list_class = new \Common\qscmstag\explain_listTag(array('列表名'=>'list','cache'=>'0','type'=>'run',));$list = $tag_explain_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"资讯中心 -  {categoryname} -{site_name}","keywords"=>"","description"=>"","header_title"=>""),$list);?>
...
<?php if(($show_backtop) == "1"): ?><div class="item mobile">
    <a class="blk"></a>
    <?php if(($show_backtop_app) == "1"): ?><div class="popover <if condition="$show_backtop_weixin eq 1">popover1<?php endif; ?>">
