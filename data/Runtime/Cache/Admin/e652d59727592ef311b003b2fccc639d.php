...
<script>
	var URL = '/zhaopin42/index.php/admin/category_jobs',
		SELF = '/zhaopin42/index.php?m=admin&amp;c=category_jobs&amp;a=index',
        ...
        if (result.status==1){
            ...
            for (x in result.data) {
                ...
                if(level < Maxlevel){
                    ...
                    html+="<a href=\"<?php echo U('edit');?>&edit_content=1&id="+result.data[x]['id']+"\">[职位描述模板]</a>";
                }
