...
<script>
	var URL = '/zhaopin42/index.php/admin/mailconfig',
		SELF = '/zhaopin42/index.php?m=admin&amp;c=mailconfig&amp;a=testing',
...
<body style="background-color:#E0F0FE">
	...
	<span id="submitbox">
		<form action="<?php echo U('mailconfig/testing');?>" method="post"   name="form1" id="form1">
		<table width="700" border="0" cellspacing="10" cellpadding="1" style=" margin-bottom:3px;">
			<tr>
            <td width="100" align="right">收件人地址:</td>
            <td width="560">
			<input name="email" type="text"  class="input_text_200"  value="" maxlength="30"/></td>
          </tr>
          <tr>
            <td align="right">&nbsp;</td>
