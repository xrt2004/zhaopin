...
<script>
	var URL = '/zhaopin42/index.php/admin/config',
		SELF = '/zhaopin42/index.php?m=admin&amp;c=config&amp;a=agreement',
...
<div class="toptit">会员注册协议</div>
	<form action="<?php echo U('text/edit');?>" method="post" name="form1" id="form1">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
			<tr>
				<td width="441">
					<textarea name="value" style=" width:700px;height:400px; font-size:12px; line-height:180%"  id="agreement"><?php echo ($agreement["value"]); ?></textarea>
				</td>
			</tr>
			<tr>
				<td height="50">
