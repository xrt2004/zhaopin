...
<script>
	var URL = '/zhaopin42/index.php/admin/admin',
		SELF = '/zhaopin42/index.php?m=admin&amp;c=admin&amp;a=index',
...
<body style="background-color:#E0F0FE">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="list" class="link_lan">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="admin_list"><?php echo admin_date($list['add_time']);?></td>
				<td class="admin_list">
					<?php if($list['last_login_time'] == 0): ?>从未
					<?php else: ?>
						<?php echo admin_date($list['last_login_time']); endif; ?>
				</td>
				<td class="admin_list">
				...
				<td class="admin_list" align="center">
					...
					&nbsp;&nbsp;
					<?php if($list['role']['id'] != 1): if($apply['Subsite']): ?><a class="J_subsite" href="javascript:;" parameter="id=<?php echo ($list['id']); ?>">分站</a>
						<?php else: ?>
