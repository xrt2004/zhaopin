...
class MenuModel extends Model {
    ...
    public function sub_menu_cache($pid = 0){
        ...
        $menuData = M('AdminAuth')->where($where)->join($join)->order('m.ordid,m.id')->getfield('m.id,m.name,m.menu_type,m.module_name,m.controller_name,m.action_name,m.data,m.stat');
