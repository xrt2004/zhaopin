...
class JobsTmpModel extends Model{
	protected $_validate = array(
		...
		array('uid,company_id,company_addtime,stick,nature,sex,amount,topclass,category,subclass,trade,scale,district,sdistrict,tdistrict,tag,education,experience,wage,deadline,setmeal_deadline,setmeal_id','identicalEnum','',0,'callback'),
