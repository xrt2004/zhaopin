...
class SubsiteModel extends Model
{
	...
	public function subsite_cache(){
		$data = $this->where(array('s_effective'=>1))->order('s_order desc,s_id')->getfield('s_id,s_domain,s_m_domain,s_sitename,s_district,s_districtname,s_logo_home,s_logo_user,s_logo_other,s_title,s_keywords,s_description,s_tpl,s_level,s_map_ak,s_map_zoom,s_map_center_x,s_map_center_y');
