	...
	function swipe_self()
	{
        ...
        var swipePage = {
            ...
            init: function() {
                ...
                if (browser != "zhuzhan" && browser != "58weiyingxiao" && browser != "bangjob" && browser != "bangbang" && browser != "bangbangandbangjob") {
                    swipePage.openApp()
                }
            ...
            swipeUpInit: function() {
                ...
                $("#poster_contain").swipeUp({
                    ...
                    afterSwipe: function(index) {
                        ...
                        if (browser != "zhuzhan" && browser != "58weiyingxiao" && browser != "bangjob" && browser != "bangbang" && browser != "bangbangandbangjob") {
                            var getLength = $(".poster_wrap").length - 3;
                            if ($("#poster_contain section:nth-last-of-type(2)").hasClass("focus")) {
                                clickLog("from=guideapp-guidepage" + pageConfig.proline);
                                swipePage.isOpen = true
                            } else if (index == getLength || index == 0) {
                                swipePage.isOpen = false
                            }
                            if ($(".download-app").hasClass("focus")) {
                                clickLog("from=guideapp-downloadpage-" + pageConfig.proline);
                                if (swipePage.isOpen) {
                                    clickLog("from=guideapp-handleup" + pageConfig.proline);
                                    if (isshangjia) {
                                        var url = "//vdian.vip.58.com/user/info/" + pageConfig.userid + "/0?isshangjia=true&from=guideapp";
                                        var guideApp = new GuideApp({
                                            url: url,
                                            dom: "#poster_contain",
                                            pagetext: "职位",
                                            clickLog: "guideapp-bannerclick-" + pageConfig.proline,
                                            clickFn: function() {
                                                var index = $("#poster_contain .poster_wrap").index(".download-app");
                                                $("#poster_contain").swipeUp({
                                                    index: index
                                                });
                                                setTimeout(function() {
                                                    $("#poster_contain .poster_wrap").eq(index).addClass("focus")
                                                }, 16)
                                            }
                                        })
                                    }
            ...
            openApp: function() {
                ...
                $(".download-btn").bind("click", function() {
                    clickLog("from=guideapp-download-" + pageConfig.proline);
                    window.location.href = "http://api.wireless.58.com/api/redirect/down/1051?pid=1051"
                })
            },
